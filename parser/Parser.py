class Parser:
    ...
    def parse_comparison(self):
        ...
        while True:
            ...
            left = {"type = operation", "operator = " + str(op["type"]), "left = " + str(left), "right = " + str(right)}
        return left
    ...
    def parse_factor(self):
        ...
        op = self.peek()
        while op is not None and op["type"] in ["TIMES", "DIVIDE"]:
            self.get()
    ...
    def parse_unary(self):
        ...
        if op is not None and op["type"] in ["PLUS", "MINUS", "NOT"]:
            self.get()
            return {"type = operation", "operator = " + str(op["type"]), "operand = " + str(self.parse_unary())}
